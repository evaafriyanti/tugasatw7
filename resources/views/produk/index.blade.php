		...
		<div class="row">
			...
			<div class="col-md-12 mt-5">
				<div class="card">
					<div class="card-header">
						Data Produk
						<a href="{{url('produkcreate')}}" class="btn btn-dark float-right"><i class="fa fa-plus"></i> Tambah Data </a>
					</div>
					<div class="card-body">
						<table class="table">
							<thead>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="btn-group">
										<a href="{{url($produk->id)}}" class="btn btn-dark"><i class="fa fa-info"></i></a>
