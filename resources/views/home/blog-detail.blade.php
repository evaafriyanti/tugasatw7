...
<html lang="en">
<head>
	<title>Eva Afriyanti Shop | Blog-Detail</title>
	<meta charset="UTF-8">
	...
	<header class="header-v4">
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<a href="{{url('menu')}}" class="flex-c-m trans-04 p-lr-25">
							Home Admin
						</a>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class="label1" data-label1="hot">
								<a href="{{url('shopingcart')}}">Features</a>
							</li>
		...
		<div class="menu-mobile">
			<ul class="topbar-mobile">
				...
				<li>
					<div class="right-top-bar flex-w h-full">
						...
						<a href="{{url('menu')}}" class="flex-c-m p-lr-10 trans-04">
							Home Admin
						</a>
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="{{url('shopingcart')}}" class="label1 rs1" data-label1="hot">Features</a>
				</li>
